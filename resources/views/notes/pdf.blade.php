...
<body style="font: 14px/1.4 Georgia, serif; margin: 0; padding: 0;">
	...
	<div style="width: 90%; margin: 20px 0; background: #000; text-align: center; color: white; font: bold 15px Helvetica, Sans-Serif; text-decoration: uppercase; letter-spacing: 20px; padding: 8px 0px;">FACTUUR</div>
	...
	<table style="clear: both; width: 90%; margin: 30px 0 0 0; border: 1px solid black; border-collapse: collapse;">
		<tr>
